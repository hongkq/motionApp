...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static String url = Server.ADDR + "authenticate";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mForgotPwdButton = (Button) findViewById(R.id.forgot_passsword_button);
        mForgotPwdButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password) {
            mEmail = email;
            mPassword = password;
            MyRequestQueue = Volley.newRequestQueue(LoginActivity.this);
        }
...
/*
            ...
            strRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>(){
                ...
                public void onErrorResponse(VolleyError error) {
                    Log.e("Error response from server ", ""+error.getMessage());
...
*/
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            par.put("email", mEmail);
            par.put("pwd", mPassword);
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                if(response.getBoolean("auth")) {
                                    Intent intent = new Intent(LoginActivity.this, HomepageActivity.class);
                                    intent.putExtra("utaid", response.getString("utaid"));
